<div class=" flex items-center justify-center p-6 overflow-y-auto h-screen scrollbar-hide">

    <div class="w-full max-w-lg bg-[#2F2F2F] p-6 mb-16 mt-12 rounded-xl shadow">
        ...
        <form id="blogForm" enctype="multipart/form-data">
            @csrf
            <div class="md:flex md:flex-raw gap-2">
                <div>
                    {{-- Title --}}
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" rows="5"
                            class="w-full mt-1 px-1 py-1 md:px-3 md:py-2 rounded-lg bg-[#3A3A3A] text-white">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="text-red-400 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="flex justify-end gap-2">
                <a href="{{ url()->previous() }}" class="px-4 py-2 bg-gray-500/20 text-gray-300 rounded" id="backBtn">
                    Back
                </a>
