                    ...
                    <section class="p-6 page-blog">
                        <div class=" bg-[#2F2F2F] rounded-2xl  p-3 md:p-6 overflow-x-auto">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <a href="" class="px-4 py-2 bg-[#9c1428] hover:bg-[#7d7d7d] text-white rounded text-sm">
                                    Add Gallery
                                </a>
                            </div>
                                ...
                                <tbody class="text-[11px] md:text-sm ">
                                    @forelse($galleries as $gallery)
                                        <tr class="bg-[#3A3A3A] hover:bg-[#444] transition">
                                            ...
                                            <!-- Status -->
                                            <td class="px-2 md:px-4 py-1 md:py-2">
                                                <span x-data="{ status: 'active' }"
                                                    :class="status === 'active' ? 'bg-green-400/10 text-green-400' : 'bg-gray-400/10 text-gray-400'"
                                            ...
                                            <td class="px-2 md:px-4 py-1 md:py-2 text-right" x-data="{ open:false }"> <button
                                                ...
                                                <div x-show="open" @click.outside="open=false"
                                                    ...
                                                    <a href="#" class="block px-4 py-2 hover:bg-gray-100">View Details</a>
                                                    <a href="#" class="block px-4 py-2 text-red-600 hover:bg-red-50">Remove</a>
                                                </div>
                                            </td>
                                        </tr>
                                    @empty
