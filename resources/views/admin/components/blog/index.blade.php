    ...
    <section class="bg-[#393738] font-sans h-screen overflow-hidden">
        <div class="flex h-full">
            ...
            <div class="flex-1 flex flex-col  bg-[#393738]">
                ...
                <div id="main-content">
                    <section class="p-6 page-blog">
                        <div class=" bg-[#2F2F2F] rounded-2xl  p-3 md:p-6 overflow-x-auto">
                            <div class="flex items-center justify-between mb-2">
                                <h1 class="text-2xl font-bold mb-4 text-white">Blog</h1>
                            ...
                            <table class="w-full border-separate border-spacing-y-1 md:border-spacing-y-1">
                                <thead>
                                    <tr class="text-gray-400 text-[10px] md:text-sm text-left">
                                        ...
                                        <th class="px-2 md:px-4 py-1 md:py-2 text-left text-sm">Description</th>
                                ...
                                <tbody class="text-[11px] md:text-sm ">
                                    @forelse ($blogs as $blog)
                                                                <tr class="bg-[#3A3A3A] hover:bg-[#444] transition">
                                                                    ...
                                                                    <!-- Title -->
                                                                    <td class="px-2 md:px-4 py-1 md:py-2 text-white">
                                                                        {{ $blog->title }}
                                                                    </td>
                                                                    <!-- Description -->
                                                                    <td class="px-2 py-1 text-white align-middle">
                                                                        <div class="line-clamp-2 text-xs leading-snug max-w-[260px] text-gray-300">
                                                                            {{ $blog->description }}
                                                                        </div>
                                                                    </td>
                                                                    <!-- Views -->
                                                                    <td class="px-2 md:px-4 py-1 md:py-2"><span
                                                                            class="bg-yellow-500/20 text-yellow-400 text-xs inline-flex items-center rounded-md px-2 py-1 text-sm">{{ $blog->views }}</span>
                                                                    </td>
                                                                    ...
                                                                    <td class="px-2 md:px-4 py-1 md:py-2 text-right" x-data="{ open:false }"> <button
                                                                        ...
                                                                        <div x-show="open" @click.outside="open=false"
                                                                            ...
                                                                            <a href="#" data-id="{{ $blog->id }}"
                                                                                class="deleteBtn block px-4 py-2 text-red-600 hover:bg-red-50">Remove</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                    @empty
